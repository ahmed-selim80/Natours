...
const { distinct } = require("../models/tourModel");
...
// /tours-within/233/center/34,56/unit/mi
exports.getToursWithin = catchAsync (async (req , res , next) => {
  ...
  if (!lat || !lng){
    next(new AppError("PLease provide latitude and longitude in the format lat,lng" , 400)) // 400 -> Bad Request
  }
